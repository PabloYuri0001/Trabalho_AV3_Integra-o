...
public class FinanceiroDespesaDTO {
    ...
    public FinanceiroDespesaDTO(BigDecimal totalGeral, BigDecimal totalMensal, BigDecimal totalSemanal, BigDecimal totalDiario) {
